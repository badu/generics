...
func Map[T any, R any](source []T, fn func(T, int) R) []R {
...
func MapWhere[T any, R any](source []T, fn func(T, int) (R, bool)) []R {
	var result []R
...
func FlatMap[T any, R any](source []T, fn func(T, int) []R) []R {
	var result []R
